    ...
    <main class="min-h-screen">
        ...
        <div class="w-full bg-night">
            ...
            <div class="container pb-14 pt-10 px-4 lg:px-0 lg:pb-28 lg:pt-20 mx-auto grid lg:grid-cols-2 grid-cols-1">
                <div class="">
                    <p class="text-night bg-day px-0.5 inline-block uppercase mb-2.5 text-sm lg:text-base">Artificial intelligence</p>
                    <a href="{{route('article.show','article_slug')}}">
                        <p class="text-white hover:underline hover:decoration-2 uppercase text-xl lg:text-3xl mb-4">artificial intelligence (AI),
                ...
                <div class=" hidden lg:block">
                    <div class="flex justify-end items-center">
                        <div class="slideshow-container flex justify-between items-center w-3/4">
                            <a class="prev m-5 text-leaf  bg-white text-base px-2.5 h-10 flex justify-center items-center"
                            ...
                            <a class="next m-5 text-leaf  bg-white text-base px-2.5 h-10 flex justify-center items-center"
        ...
        <div class="container mx-auto py-7 px-4 lg:px-0">
            <h2 class="uppercase text-center underline decoration-leaf decoration-2 underline-offset-8 font-bold text-2xl lg:text-4xl">Journals
            </h2>
            <div class="grid grid-cols-1 lg:grid-cols-2 my-10 lg:my-16">
                <div class="">
                    <p class="text-white bg-night px-0.5 inline-block uppercase mb-2.5 text-sm lg:text-base">Computer</p>
                    <p class="my-2 hover:underline hover:decoration-2 uppercase text-xl lg:text-3xl">Computer Simulation and Health
                        Informatics</p>
                ...
                <div class="mt-4 lg:mt-0">
                    ...
                    <p class="text-base text-night">Informatics in Medicine Unlocked (IMU) is an international gold open access journal covering a broad spectrum of topics within medical informatics, including (but not limited to) papers focusing on imaging, pathology, teledermatology, public health, ophthalmological, nursing and translational medicine informatics. The full papers that are published in the journal are accessible to all who visit the website.</p>
                    <a href="#" class="text-base text-leaf">Read More</a>
                    <div class="grid grid-cols-2 lg:grid-cols-3">
                        <div class="my-5 ">
                            <p class="flex items-center"><span class="iconify text-leaf mr-2" data-icon="bxs:bar-chart-alt-2"></span>Top Readership</p>
                        ...
                        <div class="my-5 ">
                            <p class="flex items-center"><span class="iconify text-leaf mr-2" data-icon="bx:time"></span>Time to first decision</p>
                            <div class="flex text-lg font-bold my-1">
                                <p>2.6 Weeks</p>
                            </div>
                        </div>
                        <div class="my-5 ">
                            <p class="flex items-center"><span class="iconify text-leaf mr-2" data-icon="bx:time"></span>Review time</p>
                            <div class="flex text-lg font-bold my-1">
                                <p>1.2 Weeks</p>
                            </div>
                        </div>
                        <div class="my-5 ">
                            <p class="flex items-center"><span class="iconify text-leaf mr-2" data-icon="bx:time"></span>Publication time</p>
                            <div class="flex text-lg font-bold my-1">
                                <p>1.5 Weeks</p>
                            </div>
                        </div>
                        <div class="my-5 ">
                            <p class="flex items-center"><span class="iconify text-leaf mr-2" data-icon="bxs:bar-chart-alt-2"></span>Articale Publishing Charge</p>
                            <div class="flex text-lg font-bold my-1">
                                <p>*FREE</p>
                            </div>
                        </div>
        ...
        {{-- latest research --}}
        <div class="container mx-auto py-7 px-4 lg:px-0">
            <h2 class="uppercase text-center underline decoration-leaf decoration-2 underline-offset-8 font-bold text-2xl lg:text-4xl">latest
                research</h2>
            <div class="lg:grid grid-cols-1 lg:grid-cols-3 my-16">
                <div class="letReserch hover:bg-night py-12 px-8 border border-night my-4 lg:my-0">
                    <p class="mb-2 hover:underline hover:decoration-2 uppercase text-xl lg:text-2xl text-night">Informatics in Medicine
        ...
        {{-- Editorial Board --}}
        <div class="container mx-auto py-7 px-4 lg:px-0">
            <h2 class="uppercase text-center underline decoration-leaf decoration-2 underline-offset-8 text-2xl font-bold lg:text-4xl">Editorial Board
            </h2>
            <div class="grid grid-cols-1 lg:grid-cols-2 my-16">
                <div class="">
                    <p class="text-white bg-night px-0.5 inline-block uppercase mb-2.5 text-sm lg:text-base">full editorial board</p>
                    <p class="my-2 hover:underline hover:decoration-2 uppercase text-xl lg:text-3xl">72 Editors and editorial board
                    ...
                    <a href="#" class="flex items-center  text-leaf my-4 text-lg"><span class="iconify" data-icon="akar-icons:chevron-right"></span>View Editorial Board</a>
                </div>
                <div class="">
                    <div class="flex items-center">
                        <img src="{{asset('images/editor/editor.png')}}" class="rounded rounded-full mr-3" alt="Editor">
        ...
        <div class="bg-cream">
            <div class="container mx-auto py-12">
                <h2 class="uppercase text-center underline decoration-night decoration-2 underline-offset-8 text-2xl lg:text-4xl">
                    <strong>Subscribe</strong> for Latest Article <br> and
                    Get notified of the best Journals</h2>
                <div class="flex justify-center my-16">
                    <form action="" method="post" class="flex md:w-2/4 justify-center flex-col md:flex-row">
                        <input type="email" class="grow py-4 px-10 border bg-transparent border-night text-night md:mr-4"
