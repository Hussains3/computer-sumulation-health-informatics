                        ...
                        <div class="col-span-3 border border-gray">
                            ...
                            <form action="" method="post" class="  p-4">
                                ...
                                <div class="flex w-full flex-col mb-2">
                                    ...
                                    <textarea name="" id="" cols="30" rows="3" class="w-full border-gray"></textarea>
                                </div>
                        ...
                        <div class="col-span-2 border border-gray">
                            ...
                            <div class="">
                                <ul class="list-decimal ml-8 py-4">
                                    <li class="">
                                        <h3 class="font-bold">Ishtiuq</h3>
                                        <p>Email: <a href="" class="text-leaf">email@mail.com</a></p>
                                        <button class="bg-night hover:bg-leaf hover:text-white py-1 hidden px-4 text-white"><span class="iconify" data-icon="dashicons:trash"></span></button>
                                    </li>
                                </ul>
                            </div>
                        </div>
